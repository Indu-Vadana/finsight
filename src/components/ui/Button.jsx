...
export function Button({
  ...
  const variants = {
    ...
    secondary:
      'bg-dark-700/80 border border-white/[0.08] text-slate-200 hover:bg-dark-600/80 hover:border-white/[0.14] disabled:opacity-50',
    danger:
      'bg-gradient-to-r from-rose-500 to-rose-600 text-white hover:shadow-glow disabled:opacity-50',
    ghost:
      'bg-transparent text-slate-400 hover:bg-dark-700/60 hover:text-slate-200 disabled:opacity-50',
    accent:
